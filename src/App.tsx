  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 transition-colors">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="border border-gray-300 rounded-lg px-3 py-2 dark:bg-gray-800 dark:border-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none"
            >
        ...
        {/* YÜKLENİYOR DURUMU */}
        {loading && (
          <p className="text-center text-gray-500">Projeler Yükleniyor...</p>
        )}
